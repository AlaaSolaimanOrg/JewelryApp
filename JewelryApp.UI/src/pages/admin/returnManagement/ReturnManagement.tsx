        ...
        >
          ...
          <div className="return-card__actions">
            <div className="return-id">
              Receipt: {returnData.saleSerialNumber}
            </div>
            <span className="items-count">
              {returnData.items?.length} items
            </span>
                    ...
                    <tbody>
                      {returnData.items?.map((item, index) => (
                        <tr key={item.id}>
                          ...
                          <td>{item.sku}</td>
                          <td>
                            <Badge bg="" className="badge-karat">
                              {item.karat}K
                            </Badge>
                          </td>
                          <td>{item.weight}g</td>
    ...
    <div id="return-management" className="page">
        ...
        <div className="filters-container">
          <div className="search-filter-row">
            ...
            >
              ...
              <option value={ReturnOption.MeltAfterReturn}>To Melt</option>
            </select>
          </div>
        </div>
      </header>
      ...
      <section className="section">
        ...
        <span className="return-count">
          ...
          {returnedToStock?.length === 1 ? "return" : "returns"}
        </span>
